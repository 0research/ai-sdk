...
# def generate_merge_strategy_radio(tab_labels):
#     return dbc.FormGroup([
#         dbc.Label("Choose a Merge Strategy", style={'display':'inline-block'}),
#         dbc.RadioItems(
#             options=[{'label': tab_labels[i], 'value': str(i)} for i in range(len(tab_labels))],
#             value=1,
#             id="radio_merge_strategy",
#         ),
#     ])
...
#     html.Div(children=[
#         # generate_merge_strategy_radio(tab_labels),
